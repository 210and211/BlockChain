...
public class MedicalRecords implements Serializable {
    ...
    private LocalDate operateTime;           //信息产生时间
    ...
    public MedicalRecords(long preBlockIndex, LocalDate operateTime,int opHospitalID, int infoID, int hospitalID, long patientID, String section){
        this.preBlockIndex = preBlockIndex;
